...
public class JavaBeanElasticsearchProgrammaticMappingIT {
	...
	public void setup() {
		...
		backendMock.expectSchema( JavaBeanElasticsearchAnnotationMappingIT.OtherIndexedEntity.INDEX, b -> b
				.field( "numeric", Integer.class )
				.field( "numericAsString", String.class )
		);
		backendMock.expectSchema( JavaBeanElasticsearchAnnotationMappingIT.YetAnotherIndexedEntity.INDEX, b -> b
		...
		backendMock.expectSchema( JavaBeanElasticsearchAnnotationMappingIT.IndexedEntity.INDEX, b -> b
