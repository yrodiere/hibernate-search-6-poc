...
public class OrmAutomaticIndexingIT {
	...
	public void directAssociationUpdate_single() {
		...
		OrmUtils.withinTransaction( sessionFactory, session -> {
			...
			containedEntity.setContainingAsSingle( Arrays.asList( entity1 ) );
	...
	public void directAssociationUpdate_list() {
		...
		OrmUtils.withinTransaction( sessionFactory, session -> {
			...
			containedEntity.setContainingAsList( Arrays.asList( entity1 ) );
	...
	public void directAssociationUpdate_mapValues() {
		...
		OrmUtils.withinTransaction( sessionFactory, session -> {
			...
			containedEntity.setContainingAsMapValues( Arrays.asList( entity1 ) );
	...
	public void directAssociationUpdate_mapKeys() {
		...
		OrmUtils.withinTransaction( sessionFactory, session -> {
			...
			containedEntity.setContainingAsMapKeys( Arrays.asList( entity1 ) );
	...
	public static class ContainingEntity {
		...
		private Map<String, ContainedEntity> containedMapValues;
		...
		private Map<ContainedEntity, String> containedMapKeys;
