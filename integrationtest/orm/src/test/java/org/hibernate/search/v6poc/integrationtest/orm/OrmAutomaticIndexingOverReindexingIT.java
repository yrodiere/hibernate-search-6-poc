...
public class OrmAutomaticIndexingOverReindexingIT {
	...
	@TypeBridgeMapping(builder = @TypeBridgeMappingBuilderReference(type = Level3Property1Bridge.Builder.class))
	...
	public static class Level3Property1Bridge implements TypeBridge {
		...
		public static class Builder
				implements AnnotationBridgeBuilder<Level3Property1Bridge, Level3Property1BridgeAnnotation> {
			@Override
			public void initialize(Level3Property1BridgeAnnotation annotation) {
				// Nothing to do
			}

			@Override
			public Level3Property1Bridge build(BuildContext buildContext) {
				return new Level3Property1Bridge();
			}
		}
