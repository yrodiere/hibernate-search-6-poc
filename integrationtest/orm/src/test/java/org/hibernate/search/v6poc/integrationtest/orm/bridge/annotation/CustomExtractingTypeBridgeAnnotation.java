...
import org.hibernate.search.v6poc.integrationtest.orm.bridge.CustomExtractingTypeBridge;

@Retention(RetentionPolicy.RUNTIME)
@Target({ ElementType.FIELD, ElementType.METHOD })
@PropertyBridgeMapping(builder = @PropertyBridgeMappingBuilderReference(type = CustomExtractingTypeBridge.Builder.class))
public @interface CustomExtractingTypeBridgeAnnotation {
