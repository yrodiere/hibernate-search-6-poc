 ...
 *         (a dot-separated sequence of the properties mentioned in the path prefix).
 *     </li>
 *     <li>
 ...
 *         and alternatively as the collection role.
 *     </li>
 *     <li>
...
public class HibernateOrmPathFilterFactory implements PojoPathFilterFactory<Set<String>> {
	...
	public PojoPathFilter<Set<String>> create(Set<PojoModelPathValueNode> paths) {
		...
		Set<String> pathsAsStrings = new LinkedHashSet<>();
